...
dependencyManagement {
    ...
    dependencies {
        ...
        dependency("org.camunda.bpm.springboot:camunda-bpm-spring-boot-starter:3.2.1")
...
dependencies {
    ...
    implementation("org.camunda.bpm.springboot:camunda-bpm-spring-boot-starter-test:3.2.1")
